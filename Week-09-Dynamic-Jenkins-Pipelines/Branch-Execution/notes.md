[![Sector](https://img.shields.io/badge/SECTOR-Dynamic_Jenkins_Pipelines-00E5FF?style=flat-square&labelColor=0A0A0A)](#) [![Module](https://img.shields.io/badge/MODULE-notes-FF0055?style=flat-square&labelColor=0A0A0A)](#)
...
- **The BRANCH_NAME Variable Pitfall:** Learned that `env.BRANCH_NAME` only exists in Multibranch pipelines. In standalone jobs, it returns `null`, and you have to detect the branch manually using Git commands.
