[![Sector](https://img.shields.io/badge/SECTOR-future_roadmap-00E5FF?style=flat-square&labelColor=0A0A0A)](#) [![Module](https://img.shields.io/badge/MODULE-3_month_plan-FF0055?style=flat-square&labelColor=0A0A0A)](#)
...
- Katacoda Kubernetes labs (interactive)
...
- Deploying EC2, VPC, S3 with Terraform
...
| 5 | AWS IAM | | |
| 6 | AWS S3 | | |
| 7 | AWS ALB + Auto Scaling | | |
| 8 | EKS | | |
| 9 | Terraform basics | | |
| 10 | Terraform EC2 + VPC | | |
| 11 | Terraform modules | | |
| 12 | Review + mini project | | |
