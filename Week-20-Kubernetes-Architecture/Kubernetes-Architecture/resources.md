# ✦ Resources: Kubernetes Architecture
...
| Kubeadm Bootstrapping Guide | Portal | Production cluster lifecycle management instructions. | [Read Here](https://kubernetes.io/docs/setup/production-environment/tools/kubeadm/create-cluster-kubeadm/) |
